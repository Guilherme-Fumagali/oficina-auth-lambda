...
- **Concorrência reservada de 10:** limita o número de conexões simultâneas ao `db.t4g.micro`, que suporta cerca de 85. Para maior concorrência, a alternativa é o RDS Proxy.
